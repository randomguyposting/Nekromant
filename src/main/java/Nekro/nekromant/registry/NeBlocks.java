...
public class NeBlocks {
    ...
    public static final RegistryObject<Block> PURPLE_DUNGEON_PILLAR = BLOCKS.register("purple_dungeon_pillar", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE)));
}
