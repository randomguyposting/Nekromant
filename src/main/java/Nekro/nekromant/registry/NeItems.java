...
public class NeItems {
    ...
    public static final RegistryObject<BucketItem> BLOOD_BUCKET = ITEMS.register("blood_bucket", () -> new BucketItem(NeFluids.BLOOD_SOURCE, (new Item.Properties().tab(NeCreativeModeTab.NEKROMANT_MISC).stacksTo(1))));
